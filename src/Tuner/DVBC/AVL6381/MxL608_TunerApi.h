...
MXL608_STATUS MxLWare608_API_CfgDevOverwriteDefaults(UINT32_608 Port, UINT8_608 devId, MXL608_BOOL singleSupply_3_3V);
...
MXL608_STATUS MxLWare608_API_ReqDevVersionInfo(UINT32_608 Port, UINT8_608 devId, MXL608_VER_INFO_T* mxlDevVerInfoPtr);
MXL608_STATUS MxLWare608_API_ReqDevGPOStatus(UINT32_608 Port, UINT8_608 devId, MXL608_GPO_STATE_E* gpoStatusPtr);
MXL608_STATUS MxLWare608_API_ReqDevPllState(UINT32_608 Port, UINT8_608 devId, MXL608_PLL_STATE_E* PllStatePtr);

MXL608_STATUS MxLWare608_API_CfgTunerMode(UINT32_608 Port, UINT8_608 devId, MXL608_TUNER_MODE_CFG_T tunerModeCfg);
...
MXL608_STATUS MxLWare608_API_CfgTunerChanTune(UINT32_608 Port, UINT8_608 devId, MXL608_CHAN_TUNE_CFG_T chanTuneCfg);

MXL608_STATUS MxLWare608_API_ReqTunerAGCLock(UINT32_608 Port, UINT8_608 devId, MXL608_BOOL* agcLockStatusPtr);
MXL608_STATUS MxLWare608_API_ReqTunerLockStatus(UINT32_608 Port, UINT8_608 devId, MXL608_BOOL* rfLockPtr, MXL608_BOOL* refLockPtr);
