...
MXL608_STATUS MxLWare608_OEM_WriteRegister(UINT32_608 Port, UINT8_608 devId, UINT8_608 RegAddr, UINT8_608 RegData)
{
...
/*
  ...
  */
  ...
  //else
  //{
  r = AVL6381_TunerWrite(Port, i2c_addr, buffer, size);
  //}
  //if (r != AVL6381_EC_OK)
  //{
     // return MXL603_FALSE;
...
MXL608_STATUS MxLWare608_OEM_ReadRegister(UINT32_608 Port, UINT8_608 devId, UINT8_608 RegAddr, UINT8_608 *DataPtr)
{
...
/*
  ...
  */
  ...
  //else
  //{
  r = AVL6381_TunerRead(Port, i2c_addr, buffer, 2, DataPtr, 1);
  //}
...
void MxLWare608_OEM_Sleep(UINT16_608 DelayTimeInMs)
{
  ...
  AVL6381_IBSP_Delay(DelayTimeInMs);
}
