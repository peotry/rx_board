...
extern "C" {
    ...
    struct AVL_Tuner
    {
        ...
        AVL_DVBSx_ErrorCode (* m_pInitializeFunc)(struct AVL_Tuner *, AVL_uint32);      ///< A pointer to the tuner initialization function.
        ...
        AVL_DVBSx_ErrorCode (* m_pLockFunc)(AVL_uint32 , AVL_uint32 , AVL_uint32 , struct AVL_DVBSx_Chip * );         ///< A pointer to the tuner Lock function.
    };
