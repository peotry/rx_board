...
AVL_DVBSx_ErrorCode AVL_DVBSx_IBlindScanAPI_Start(AVL_uint32 u32Port, struct AVL_DVBSx_Chip * pAVLChip, struct AVL_Tuner * pTuner, struct AVL_DVBSx_BlindScanAPI_Setting * pBSsetting)
{
    ...
    r |= AVL_DVBSx_IBase_SetSpectrumPolarity(u32Port, pBSsetting->m_eSpectrumMode,pAVLChip);
    ...
    r |= pTuner->m_pLockFunc(u32Port, pTuner->m_uiFrequency_100kHz, pBSsetting->m_uiScan_Max_Symbolrate_MHz, pAVLChip);   //Lock the tuner.
    ...
    r |= AVL_DVBSx_IBlindScan_Scan(u32Port, pbsPara,340, pAVLChip);
    pBSsetting->m_uiScaning_Flag = 1;
    
    return r;
}

AVL_DVBSx_ErrorCode AVL_DVBSx_IBlindScanAPI_GetCurrentScanStatus(AVL_uint32 u32Port, struct AVL_DVBSx_Chip * pAVLChip,struct AVL_DVBSx_BlindScanAPI_Setting * pBSsetting)
{
    AVL_DVBSx_ErrorCode r = AVL_DVBSx_EC_OK;
    struct AVL_DVBSx_BlindScanInfo * pbsInfo = &(pBSsetting->bsInfo);
    struct AVL_DVBSx_BlindScanPara * pbsPara = &(pBSsetting->bsPara);   
    
    r |= AVL_DVBSx_IBlindScan_GetScanStatus(u32Port, pbsInfo, pAVLChip);  //Query the internal blind scan procedure information.
...
AVL_DVBSx_ErrorCode AVL_DVBSx_IBlindScanAPI_Adjust(AVL_uint32 u32Port, struct AVL_DVBSx_Chip * pAVLChip,struct AVL_DVBSx_BlindScanAPI_Setting * pBSsetting)
{
    ...
    {
        r |= AVL_DVBSx_IBlindScan_ReadChannelInfo(u32Port, 0, &(pbsInfo->m_uiChannelCount), pBSsetting->channels_Temp, pAVLChip);
    }
...
AVL_DVBSx_ErrorCode AVL_DVBSx_IBlindScanAPI_Exit(AVL_uint32 u32Port, struct AVL_DVBSx_Chip * pAVLChip, struct AVL_DVBSx_BlindScanAPI_Setting * pBSsetting)
{
    AVL_DVBSx_ErrorCode r = AVL_DVBSx_EC_OK;
    struct AVL_DVBSx_BlindScanInfo * pbsInfo = &pBSsetting->bsInfo;
