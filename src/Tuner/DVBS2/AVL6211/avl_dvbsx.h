...
extern "C" {
    ...
    #define AVL_DVBSx_SB_0                  0x0C ///< Availink device slave address 0.  Up to two Availink devices are supported on one I2C bus.  
    #define AVL_DVBSx_SB_1                  0x0D ///< Availink device slave address 1.  Up to two Availink devices are supported on one I2C bus.
    ...
    /// 
//hawayi    extern const struct AVL_DVBSx_PllConf pll_conf[];
//hawayi    extern const AVL_uint16 pll_array_size;
