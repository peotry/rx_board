...
extern "C" {
	...
	AVL_DVBSx_ErrorCode AVL_DVBSx_II2CRepeater_SendData(AVL_uint32 U32Port,  AVL_uchar ucSlaveAddr, const AVL_puchar ucBuff, AVL_uint16 uiSize, struct AVL_DVBSx_Chip * pAVLChip );
