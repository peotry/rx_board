...
long unicode32ToUtf8(unsigned int *unistr,long slen,char *utf8,long utf8bufsize){
	unsigned short w;
	long count;
	char autf8[8];
	char *p;
		...
		int  nSrcLength)
{
	...
	len = unicode32ToUtf8(unicode32_text,sizeof(unicode32_text),ptDestText,nDestLength);
	return len;
}
...
{   
	...
	{
		printf("Error :call iconv_open failed.\n");
		return -1;
	}
	...
	{
		printf("Error: call iconv failed.\n");
		return -1;
	}
