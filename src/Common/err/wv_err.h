...
typedef enum{
    ...
    WV_ERR_WEB_TARFAIL              = 0x30b,
    WV_ERR_WEB_DIRCREATFAIL         = 0x30c,
    ...
    /* DS2432 */
     ERROR_DS2432_START              = 0x700,
     ERROR_DS2432_FAILURE            = 0x701,
     ERROR_DS2432_INIT_FAILURE       = 0x702,
     ERROR_DS2432_READROM_FAILURE    = 0x703,
     ERROR_DS2432_READMEM_FAILURE    = 0x704,
     ERROR_DS2432_LOADSEC_FAILURE    = 0x705,
     ERROR_DS2432_PROTECTSEC_FAILURE = 0x706,
     ERROR_DS2432_READAUTH_FAILURE   = 0x707,
     ERROR_DS2432_WRITEAUTH_FAILURE  = 0x708,
     ERROR_DS2432_BAD_PARAMS         = 0x709,
     ERROR_DS2432_NO_INIT            = 0x70a,
     ERROR_DS2432_CHECKSUM_FAILURE   = 0x70b,
